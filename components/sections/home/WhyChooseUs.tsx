              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    A two-person studio in Dar es Salaam building production-grade AI for East African businesses — fixed prices, fast shipping, and direct access to the builders.
                  </p>
                </div>
              </div>
            </div>
