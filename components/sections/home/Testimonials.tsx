              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    78% of East African SMEs sell primarily through WhatsApp — most still handle it manually and enter records by hand.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={styles.container}>
                  ...
                  <div className={styles.variant1} data-border="true">
                    <div className={styles.tittle}>
                      <p className={styles.r21}>
                        78% sell via WhatsApp
                      </p>
                    </div>
                    <div className={styles.text2}>
                      <p className={styles.r23}>
                        78% of Sub-Saharan African SMEs sell primarily through WhatsApp — but handle it manually.
                      </p>
                    </div>
                ...
                <div className={styles.r18}>
                  <div className={styles.variant1} data-border="true">
                    ...
                    <div className={styles.text2}>
                      <p className={styles.r23}>
                        We know the payment methods and WhatsApp-first, high-inbound messaging habits that outside agencies miss.
                      </p>
                    </div>
                    <div className={styles.line} />
                    <div className={styles.container2}>
