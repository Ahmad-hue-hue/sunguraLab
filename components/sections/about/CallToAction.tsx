        ...
        <div className={styles.textContainer}>
          ...
          <div className={styles.paragraph}>
            <p className={styles.r5}>
              Fixed prices, 1–4 week delivery, and two builders on your side from the first call to launch.
            </p>
          </div>
        </div>
                  ...
                  <div className={styles.big}>
                    ...
                    <div className={styles.r35}>
                      <div className={styles.r36}>
                        <CircularText className={styles.r37} text="Start a Project | Start a Project | Start a Project | Start a Project" />
                      </div>
                    </div>
                  </div>
                </div>
