              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    What we commit to on every engagement — the mission, how we work together, how we price, and the support that comes after launch.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className={styles.container}>
                  ...
                  <div className={styles.heading2}>
                    <h3 className={styles.r24}>
                      Production-grade AI at East African prices
                    </h3>
                  </div>
                </div>
                <div className={styles.container2}>
                  <div className={styles.paragraph2}>
                    <p className={styles.r27}>
                      The same core capability as $5,000+ agency builds, at a fixed price we can all afford.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      We map your real systems so answers come from your business, not assumptions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r28}>
              <div className={styles.medium2} data-border="true">
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      Agreed up front, no hourly billing, no surprise costs.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r28}>
              <div className={styles.medium2} data-border="true">
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      Post-launch support, optional $200/mo retainer.
                    </p>
                  </div>
                </div>
              </div>
